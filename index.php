        ...
        <div class="content_wrapper">
          ...
          <div id="content_area">
            ...
            <div id="shopping_cart">
              <span style ="float:right; margin:auto ; font-size:18px padding:5px;line-height:50px;">Welcome <?php 
              if(!isset($_SESSION['customer_email'])) echo "Guest !";
              else echo  $_SESSION['customer_name'];
              ?>  <b style="color:yellow">Shopping Cart - </b>Total Items:<?php total_itemf();?>  Total Price: <?php total_costf();?> <a href="cart.php" style="color:cyan">Go to  Cart</a>
              <?php
